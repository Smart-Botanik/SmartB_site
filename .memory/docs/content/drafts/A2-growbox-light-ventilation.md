...
В СмартБотаник локация типа «гроубокс» и события полива/климата помогут вести историю среды — приложение в разработке; пока фиксируйте показания датчиков рядом с этим гайдом.
```
